 ...
 */
public class MaterialsAdapter extends FirebaseListAdapter<SubTaskOrMaterial>{

    @BindView(R.id.item_material_name) TextView materialNameText;
    @BindView(R.id.item_material_checkbox) CheckBox materialCheckBox;

    public MaterialsAdapter(Activity activity, Class<SubTaskOrMaterial> modelClass, int modelLayout, Query ref) {
    ...
    @Override
    protected void populateView(View v, SubTaskOrMaterial list) {
